(function() {
	...
	Nonsense.prototype.phone = function() {
		return "(" + Math.floor(this.realInRange(100, 999)) + ") " + Math.floor(this.realInRange(100, 999)) + "-" + Math.floor(this.realInRange(1000, 9999));
	};
	
	
	Nonsense.prototype.formattedMoney = function(){
		var n = (this.uint32() + this.fract32()) / 1000, 
		c = 2, 
		d = ".", 
		t = ",", 
		s = n < 0 ? "-" : "", 
	...
	Nonsense.prototype.date = function(a, b) {
		return "" + (this.pick(DATA.dates));
	};
	...
	Nonsense.prototype.company = function() {
		return "" + (this.pick(DATA.buzz.verbs)) + " " + (this.pick(DATA.companies));
	};
	...
	DATA = {
		...
		dates: [
			new Date("2012/05/10"),new Date("2012/05/11"),new Date("2012/05/12"),new Date("2012/05/13"),new Date("2012/05/14"),new Date("2012/05/15"),
			new Date("2012/05/16"),new Date("2012/05/17"),new Date("2012/05/18"),new Date("2012/05/19"),new Date("2012/05/20") 
		],
		names: {
			first: [
		...
		companies: ['Power', 'Industries', 'Pub', 'Toys', 'Sales'],
