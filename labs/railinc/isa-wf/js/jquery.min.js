/*! BEGIN - jQuery v1.7.1 | http://jquery.com */
...
/*! BEGIN - CoolInput Plugin v2.0 | http://code.alexweber.com.br/jquery/coolinput/ */
/**
 * CoolInput Plugin
 * 
...
/*! END - CoolInput Plugin v2.0 */

/*! BEGIN - hoverIntent r5 | http://cherne.net/brian/resources/jquery.hoverIntent.html */
...
/*! BEGIN - Masked Input plugin for jQuery | http://digitalbush.com/projects/masked-input-plugin/ */
/*
            ...
            return this.trigger("unmask").each(function() {
                ...
                if (!input.attr("readonly"))
                    ...
                    .bind(pasteEventName, function() {
                        ...
                        console.log(input.caret(checkVal(true)));
...
/*! END - Masked Input plugin for jQuery */
...
/*! BEGIN jquery.fixedHeaderTable. The jQuery fixedHeaderTable plugin - http://fixedheadertable.com */
...
if(event.detail){delta=-event.detail/3;}deltaY=delta;if(orgEvent.axis!==undefined&&orgEvent.axis===orgEvent.HORIZONTAL_AXIS){deltaY=0;deltaX=-1*delta;}
