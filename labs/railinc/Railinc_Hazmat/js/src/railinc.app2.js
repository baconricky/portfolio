...
jQuery.fn.displaySearchResults = function(searchResultsTarget, searchResultsDataSrc) {	
    var $targetEl = $('#' + searchResultsTarget);
	    $targetEl.html('<h2>Your Results</h2><div class="clear">User information and instructions go here.</div><table cellpadding="0" cellspacing="1" border="0" class="tablesorter display" id="sortableTable"></table><div class="ui-helper-clearfix"></div>');
