...
var isSandbox = (host.search('localhost') > -1 || host.search('redhat.dev') > -1 || host.search('theharris.info') > -1 || host.search('qa.engage.redhat.com') > -1 || host.search('.usersys.redhat.com') > -1 || host.search('.devlab.redhat.com') > -1 || host.search('.rhcloud.com') > -1);
