/***********************************
BEGIN 3rd Party JavaScript Libs

Libraries provided in this file:
jQuery Tools v1.2.6
jQuery UI 1.8.12
...
jQuery Templates Plugin 1.0.0pre (jquery-tmpl)
jQuery Validate (rules are located in app.js)
	...
	$.fn.fixheadertable = function(options) {
		...
		return this.each(function() {
			...
			function buildHeaders(table) {
				...
				_headers = $('<table class="head"/>').append(_colgroup).append($('thead th', table));
...
rail.base = (function() {
    var i = {
        initForm: function() { //TODO: check if ":" already exists
            labels = $("label");
        ...
        applicationNavMenu: function() {
            $('#nav li').hover(function() { //show its submenu
        ...
        datePicker: function() {
            $(".dpField").datepicker({
                showOn: "button",
                buttonImage: "images/lite/calendar.gif",
...
$(function() {
	...
	$.validator.setDefaults({
		...
		errorLabelContainer: $(this).closest("div.error")
	});
	...
	jQuery.validator.addMethod("required", function(p_value, p_element)
	{
		...
		for ( key in classes ) {
			...
			if(value.indexOf('group-') >= 0) {
				...
				groupingTag = groups[1];
			}
		}
		
		console.log("groupingTag: " + groupingTag);		var isFilled = false;
		$(".group-"+groupingTag).each(function() {
			console.log(this);
		});
		
		return $(".group-"+groupingTag).size;
	...
	*/
	...
	/* Helper Functions */
	jQuery.fn.getNameFromGroupClass = function()
	{
