/**
* removed DD_roundies for curvycorners, DD doesn't work in IE7/8...
**/
...
function curvyCorners() {
  ...
  for (i = startIndex, j = boxCol.length; i < j; ++i) {
    ...
    if (!theBox.className)
      ...
      skipCorners = theBox.className.indexOf('curvyIgnore1') !== -1;
      if (!skipCorners) theBox.className += ' curvyIgnore1'; // prevent repeats
    }
    if (!skipCorners) {
