...
function checkrhuser() {
	var rhusercookie=getCookie('rh_sso');
	if (rhusercookie!=null && rhusercookie!="") {
	document.getElementById('utilityLinkRegister').innerHTML = '<a href="/wapps/ugc">Your Account</a>';
	document.getElementById('utilityLinkLogin').innerHTML = '<a href="/wapps/sso/logout.html">Logout</a>';
	} else {
	document.getElementById('utilityLinkRegister').innerHTML = '<a href="/wapps/ugc/register.html">Register</a>';
	document.getElementById('utilityLinkLogin').innerHTML = '<a href="/wapps/sso/login.html" onclick="redirect(); return false">Log In</a>';
	}
}
