...
if (!cookieGUID){
  ...
  elqCurE = "https://secure.eloqua.com/visitor/v200/svrGP.aspx";
  ...
  if ((typeof elqCurE != 'undefined') && (typeof elqPPS != 'undefined')){
    var elqScript = document.createElement("script");
      ...
      elqScript.language = "JavaScript";

      elqScript.src = elqCurE + '?pps=' + elqPPS + '&siteid=' + elqSiteID + '&ref=' + encodeURI(location.href) + '&ms=' + elqMs;
      document.body.appendChild(elqScript);
  }
