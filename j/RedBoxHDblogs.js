...
var getDimensions = function(aspectRatio){
  ...
  switch (aspectRatio) {
    ...
    default:
      dims.maxWidth = 640; // redesigned site new max size (492x369px)
      dims.maxHeight = 360 + pHeight(dims.maxWidth);
...
RedBoxHD.prototype.toDOM = function(document, s_account) {
  ...
  redBoxPlayer.setAttribute('id', 'redBoxPlayer');
    ...
    var params = {
        ...
        'bgcolor' : '#000000',
        'quality' : 'high',
	'flashvars' : 'file=' + this.movieURL + '&image=' + this.previewImg + '&omniEnv=' + s_account + '&aspect_ratio=' + this.aspectRatio + '&vid_skin=http://www.redhat.com/v/swf/redbox/redbox-gui.swf'
    };
...
$(function() {
	...
	$('.video').append('<span>Click to Play</span>');
});
